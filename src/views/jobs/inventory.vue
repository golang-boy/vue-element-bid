  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="名称" min-width="150px" align="left">
        <template slot-scope="{row}">
          <router-link :to="'/jobs/inventory/'+row.id" class="link-type">
      ...
      <el-table-column label="备注" min-width="100px" align="left">
        <template slot-scope="{row}">
...
<script>
import { fetchList, createJob, updateJob } from '@/api/jobs'
